...
function formatArticles(articles) {
  return articles.map((article) => {
    return {
      ...
      image: article.image || 'https://res.cloudinary.com/boloko/image/upload/f_auto/v1728951339/furushow7/image_smko7k.png',
      alt: article.alt || 'no alter data available',
      ogImage: article.ogImage || 'https://res.cloudinary.com/boloko/image/upload/f_auto/v1728951339/furushow7/image_smko7k.png',
