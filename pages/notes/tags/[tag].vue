...
const formattedData = computed(() => {
  return data.value?.map((articles) => {
    return {
      ...
      image: articles.image || 'https://res.cloudinary.com/boloko/image/upload/f_auto/v1728951339/furushow7/image_smko7k.png',
      alt: articles.alt || 'no alter data available',
      ogImage: articles.ogImage || 'https://res.cloudinary.com/boloko/image/upload/f_auto/v1728951339/furushow7/image_smko7k.png',
