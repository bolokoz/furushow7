    ...
    <div class="mx-auto w-full max-w-5xl px-5 py-16 md:px-10 md:py-20">
      ...
      <div class="flex flex-col items-stretch">
        ...
        <div class="gap-x-8 [column-count:1] md:grid-cols-2 md:gap-x-4 md:[column-count:2]">
          ...
          <!-- Item -->
          <div class="mb-12 inline-block border border-solid border-gray-300 md:mb-8 lg:mb-10">
            <img src="https://firebasestorage.googleapis.com/v0/b/flowspark-1f3e0.appspot.com/o/Tailspark%20Images%2FPLaceholder%20Image%20Secondary.svg?alt=media&token=b8276192-19ff-4dd9-8750-80bc5f7d6844" alt="" class="inline-block">
            <div class="px-5 py-8 sm:px-6">
              <h5 class="mb-3 text-xl font-bold">
                Project name here
              </h5>
          ...
          <!-- Item -->
          <div class="mb-12 inline-block border border-solid border-gray-300 md:mb-8 lg:mb-10">
            <img src="https://firebasestorage.googleapis.com/v0/b/flowspark-1f3e0.appspot.com/o/Tailspark%20Images%2FPLaceholder%20Image%20Secondary.svg?alt=media&token=b8276192-19ff-4dd9-8750-80bc5f7d6844" alt="" class="w-full max-h-64 object-cover">
            <div class="px-5 py-8 sm:px-6">
              <h5 class="mb-3 text-xl font-bold">
                Project name here
              </h5>
